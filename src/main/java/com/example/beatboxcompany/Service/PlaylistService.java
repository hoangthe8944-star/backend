...
public interface PlaylistService {
    ...
    // 1. Tạo Playlist mới
    PlaylistDto createPlaylist(PlaylistRequest request, String ownerId, boolean isAdmin);
    ...
    PlaylistDto addTrackToPlaylist(String playlistId, String trackId, String currentUserId, boolean isAdmin);

    // 5. Xóa bài hát khỏi Playlist
    PlaylistDto removeTrackFromPlaylist(String playlistId, String trackId, String currentUserId);

    // 6. Xóa Playlist
    void deletePlaylist(String playlistId, String currentUserId, boolean isAdmin);

    // 7. Cập nhật Playlist
    PlaylistDto updatePlaylist(String playlistId, PlaylistRequest request, String currentUserId, boolean isAdmin);
